...
impl SignalIngester for VisualIngester {
    fn ingest(
        ...
        // UNBIASED INGESTER (BSS): Raw Bayer/YUV ingestion.
        // We want to see artifacts from RF "projections" onto the sensor.
        ...
        for i in (0..pixel_count).step_by(128) {
            ...
            if intensity > 0.1 {
                particles.push(FieldParticle {
                    ...
                    intensity,
                    color: [intensity, intensity * 0.8, 0.2, 1.0], // Resonant amber/leaf
                    source_id: 3, // CMOS
                    confidence: [1.0, 0.5, 0.0, 0.0], // [Visible_Light, CMOS_Inductance, ..]
                    timestamp_us,
                    freq_hz: 500e12,
                    phase_coherence: 1.0,
                    doppler_shift: 0.0,
